...
@section('title')
<title>
    Trainers | Update Profile
  </title>
@endsection

@section('navbar')
<li class="nav-item">
  <a class="nav-link" href="/trainers/dashboard">
    <i class="material-icons">dashboard</i>
    <p>Dashboard</p>
  </a>
</li>
<li class="nav-item">
  <a class="nav-link" href="/trainers/discussions">
...
<li class="nav-item ">
  <a class="nav-link" href="/trainers/class_attendee">
    ...
    <div class="row">
      <div class="col-md-8">
        <div class="card">
          ...
          <div class="card-body">
            <form method="post" action="{{route('trainers_update_profile')}}" enctype="multipart/form-data">
            @csrf
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" name="name" value="{{Auth::user()->name}}" class="form-control @error('name') is-invalid @enderror" pattern="[a-zA-Z\s]{3,}$" autocomplete="name">
                    @error('name')
      ...
      <div class="col-md-4">
        <div class="card card-profile">
          ...
          <div class="card-body">
            <h6 class="card-category text-gray">TRAINERS</h6>
