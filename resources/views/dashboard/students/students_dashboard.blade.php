...
<li class="nav-item">
  <a class="nav-link" href="{{__('/students/discussions')}}">
    <i class="material-icons">messaget</i>
    <p>Discussions</p>
  </a>
</li>
    ...
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        <div class="card-avatar">
          ...
          <h4 class="card-title">{{Auth::user()->name}}</h4>
            ...
            @endif
          <a href="{{__('/students/profile')}}" class="btn btn-success btn-round">Update</a>
        </div>
        </div>
      </div>
      <!-- END PROFILE SECTION -->
        ...
        <div class="card card-stats">
          ...
          <div class="card-footer">
            <div class="stats">
              ...
              <a href="{{__('/students/trainers_list')}}">Observe</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-3 col-md-6 col-sm-6">
        <div class="card card-stats">
          ...
          <div class="card-footer">
            <div class="stats">
              <i class="material-icons">book</i> <a href="{{__('/students/courses')}}">observe all</a>
            </div>
          </div>
        </div>
      </div>
      <div class="col-lg-3 col-md-6 col-sm-6">
        <div class="card card-stats">
          ...
          <div class="card-footer">
            <div class="stats">
              <i class="material-icons">local_offer</i> <a href="{{__('/students/discussions')}}">Observe</a>
            </div>
          </div>
        </div>
      </div>
